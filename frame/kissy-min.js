...
var KISSY = function(a) {
	...
	i = {
		...
		version : "1.30",
		config : function(b, j) {
			var l, e, f = this, d, h = i.Config, c = h.fns;
			i.isObject(b) ? i.each(b, function(m, a) {(d = c[a]) ? d.call(f, m) : h[a] = m;}): ( l = c[b], j === a ? e = l ? l.call(f) : h[b] : l ? e = l.call(f, j) : h[b] = j);
			return e;
		},
		log : function(g, j, l) {
			if (i.Config.debug && (l && ( g = l + ": " + g), b.console !== a && console.log))
				console[j&&console[j]?j:"log"](g);
		},
		error : function(a) {
			if (i.Config.debug)
...
(function(a, b) {
	...
	function g(c, d, h, e, g, i) {
		...
		if (e) {
			v = e.length;
			for ( k = 0; k < v; k++)
				s = e[k], s in d && j(s, c, d, h, e, g, i);
		} else {
			u = a.keys(d);
			v = u.length;
			for ( k = 0; k < v; k++)
				s = u[k], s != l && j(s, c, d, h, e, g, i);
		}
		return c;
	}
	...
	function j(c, d, h, e, j, i, k) {
		if (e || !( c in d) || i) {
			...
			if (s === h)
				s === b && (d[c] = s);
			else if (i && h && (a.isArray(h) || a.isPlainObject(h)))
				h[l] ? d[c] = h[l] : ( i = s && (a.isArray(s) || a.isPlainObject(s)) ? s : a.isArray(h) ? [] : {}, d[c] = i, g(i, h, e, j, f, k));
			else if (h !== b && (e || !( c in d)))
				d[c] = h;
		}
	}

	var l = "__MIX_CIRCULAR", e = this, f = !0, d = Object.create, h = ! {
		toString : 1
	}.propertyIsEnumerable("toString"), c = "constructor,hasOwnProperty,isPrototypeOf,propertyIsEnumerable,toString,toLocaleString,valueOf".split(",");
	(function(c, a) {
		for (var d in a)
		c[d] = a[d];
	})(a, {
		...
		keys : function(a) {
			...
			if (h)
				for ( f = c.length - 1; 0 <= f; f--)
					b = c[f], a.hasOwnProperty(b) && d.push(b);
			return d;
		},
		mix : function(c, a, d, b, h) {
			"object" === typeof d && ( b = d.whitelist, h = d.deep, d = d.overwrite);
			var f = [], e = 0;
			for (g(c, a, d, b, h, f); a = f[e++]; )
				delete a[l];
			return c;
		},
		merge : function(c) {
			var c = a.makeArray(arguments), d = {}, b, h = c.length;
			for ( b = 0; b < h; b++)
				a.mix(d, c[b]);
			return d;
		},
		augment : function(c, d) {
			var h = a.makeArray(arguments), f = h.length - 2, e = 1, j = h[f], g = h[f + 1];
			a.isArray(g) || ( j = g, g = b, f++);
			a.isBoolean(j) || ( j = b, f++);
			for (; e < f; e++)
				a.mix(c.prototype, h[e].prototype || h[e], j, g);
			return c;
		},
		...
		namespace : function() {
			var c = a.makeArray(arguments), d = c.length, b = null, h, j, g, i = c[d - 1] === f && d--;
			for ( h = 0; h < d; h++) {
				g = ("" + c[h]).split(".");
				b = i ? e : this;
				for ( j = e[g[0]] === b ? 1 : 0; j < g.length; ++j)
					b = b[g[j]] = b[g[j]] || {};
			}
			return b;
		}
...
(function(a, b) {
	var i = Array.prototype, k = i.indexOf, g = i.lastIndexOf, j = i.filter, l = i.every, e = i.some, f = i.map;
	a.mix(a, {
		each : function(d, h, c) {
			if (d) {
				var m, f, e = 0;
		...
		unique : function(d, b) {
			...
			for (var m = 0, f, e; m < c.length; ) {
				for ( e = c[m]; ( f = a.lastIndexOf(e, c)) !== m; )
					c.splice(f, 1);
				m += 1;
			}
			b && c.reverse();
		...
		map : f ? function(d, a, c) {
			...
			for (var b = d.length, f = Array(b), e = 0; e < b; e++) {
				var j = "string" == typeof d ? d.charAt(e) : d[e];
				if (j || e in d)
					f[e] = a.call(c || this, j, e, d);
			}
			return f;
		},
		reduce : function(a, f, c) {
			...
			for (; e < m; )
				e in a && ( j = f.call(b, j, a[e], e, a)), e++;
			return j;
		},
		every : l ? function(a, b, c) {
			return l.call(a, b, c || this);
		} : function(a, b, c) {
			for (var f = a && a.length || 0, e = 0; e < f; e++)
				if ( e in a && !b.call(c, a[e], e, a))
					return !1;
			return !0;
		},
		...
		makeArray : function(d) {
			...
			if (a.isArray(d))
				return d;
			if ("number" !== typeof d.length || d.alert || "string" == typeof d || a.isFunction(d))
				return [d];
...
(function(a, b) {
	...
	a.mix(a, {
		...
		param : function(c, d, f, e) {
			...
			f = f || "=";
			a.isUndefined(e) && ( e = !0);
			var h = [], g, l, k, s, u, v = a.urlEncode;
			for (g in c)
			if ( u = c[g], g = v(g), i(u))
				h.push(g), u !== b && h.push(f, v(u + j)), h.push(d);
			else if (a.isArray(u) && u.length) {
				l = 0;
				for ( s = u.length; l < s; ++l)
					k = u[l], i(k) && (h.push(g, e ? v("[]") : j), k !== b && h.push(f, v(k + j)), h.push(d));
			}
			h.pop();
			return h.join(j);
		},
...
(function(a) {
	function b(a, b, g) {
		var j = [].slice, l = j.call(arguments, 3), e = function() {
		}, f = function() {
	...
	a.mix(a, {
		...
		later : function(b, k, g, j, l) {
			var k = k || 0, e = b, f = a.makeArray(l), d;
...
(function(a, b) {
	function i(b, d, e) {
		...
		if (!b)
			return c;
		if (b[l])
			return e[b[l]].destination;
		if ("object" === typeof b) {
			o = b.constructor;
			if (a.inArray(o, [Boolean, String, Number, Date, RegExp]))
				c = new o(b.valueOf());
			else if ( m = a.isArray(b))
				c = d ? a.filter(b, d) : b.concat();
			else if ( n = a.isPlainObject(b))
				c = {};
			b[l] = o = a.guid();
			e[o] = {
				destination : c,
	...
	var g = !0, j = !1, l = "__~ks_cloned", e = "__~ks_compared";
	a.mix(a, {
...
(function(a, b) {
	var i = /^[\s\xa0]+|[\s\xa0]+$/g, k = String.prototype.trim, g = /\\?\{([^{}]+)\}/g;
	a.mix(a, {
		trim : k ? function(a) {
...
(function(a, b) {
	var i = {}, k = Object.prototype.toString;
	a.mix(a, {
		isBoolean : 0,
		isNumber : 0,
		isString : 0,
...
(function(a, b) {
	...
	var h = "__promise_value", c = "__promise_pendings";
	k.prototype = {
		constructor : k,
		resolve : function(d) {
			var e = this.promise, f;
			if (!( f = e[c]))
				return b;
			e[h] = d;
			f = [].concat(f);
...
(function(a) {
	function b(a, b) {
		for (var i = 0, e = a.length - 1, f = [], d; 0 <= e; e--)
			d = a[e], "." != d && (".." === d ? i++ : i ? i-- : f[f.length] = d);
		if (b)
			for (; i--; i)
				f[f.length] = "..";
		return f = f.reverse();
	...
	var i = /^(\/?)([\s\S]+\/(?!$)|\/)?((?:\.{1,2}$|[\s\S]+?)?(\.[^.\/]*)?)$/, k = {
		resolve : function() {
			var g = "", j, i = arguments, e, f = 0;
			for ( j = i.length - 1; 0 <= j && !f; j--)
				e = i[j], "string" == typeof e && e && ( g = e + "/" + g, f = "/" == e.charAt(0));
		...
		normalize : function(g) {
			var j = "/" == g.charAt(0), i = "/" == g.slice(-1), g = b(a.filter(g.split("/"), function(a) {
				return !!a;
			}), !j).join("/");
			!g && !j && ( g = ".");
			g && i && (g += "/");
		...
		relative : function(b, j) {
			var b = k.normalize(b), j = k.normalize(j), i = a.filter(b.split("/"), function(a) {
				return !!a;
			}), e = [], f, d, h = a.filter(j.split("/"), function(a) {
				return !!a;
			});
...
(function(a, b) {
	...
	var l = /[#\/\?@]/g, e = /[#\?]/g, f = /[#@]/g, d = /#/g, h = RegExp("^(?:([\\w\\d+.-]+):)?(?://(?:([^/?#@]*)@)?([\\w\\d\\-\\u0100-\\uffff.+%]*|\\[[^\\]]+\\])(?::([0-9]+))?)?([^?#]+)?(?:\\?([^#]*))?(?:#(.*))?$"), c = a.Path, m = {
		scheme : 1,
		userInfo : 2,
		hostname : 3,
		port : 4,
	...
	j.prototype = {
		...
		toString : function(b) {
			...
			if ( m = this.path)
				f && !a.startsWith(m, "/") && ( m = "/" + m), m = c.normalize(m), h.push(g(m, e));
...
(function(a, b) {
	...
	var k = a.Env.host, g = k.document, k = ( k = k.navigator) && k.userAgent || "", j, l = "", e = "", f, d = [6, 9], h = g && g.createElement("div"), c = [], m = KISSY.UA = {
		webkit : b,
		trident : b,
		gecko : b,
		presto : b,
	...
	h && (h.innerHTML = "<\!--[if IE {{version}}]><s></s><![endif]--\>".replace("{{version}}", ""), c = h.getElementsByTagName("s"));
	if (0 < c.length) {
		e = "ie";
		m[ l = "trident"] = 0.1;
		...
		if (m[ l = "trident"] = 0.1, m[ e = "ie"] = n(f[1]), ( f = k.match(/Trident\/([\d.]*)/)) && f[1])
			m[l] = n(f[1]);
	} else if ( f = k.match(/Gecko/)) {
		m[ l = "gecko"] = 0.1;
		if (( f = k.match(/rv:([\d.]*)/)) && f[1])
			m[l] = n(f[1]);
	...
	if ("object" === typeof process) {
		var o, q;
		if (( o = process.versions) && ( q = o.node))
			j = process.platform, m.nodejs = n(q);
	}
	m.os = j;
	m.core = l;
	m.shell = e;
...
(function(a) {
	var b = a.Env, i = b.host, k = a.UA, g = i.document || {}, j = "ontouchstart" in g && !k.phantomjs, l = ( g = g.documentMode) || k.ie, e = (b.nodejs && "object" === typeof global ? global : i).JSON;
	g && 9 > g && ( e = 0);
	a.Features = {
...
(function(a) {
	...
	KISSY.Loader.Target = {
		...
		detach : function(k, g) {
			...
			if (k) {
				if ( j = b(this, k))
					g && ( l = a.indexOf(g, j), -1 != l && j.splice(l, 1)), (!g || !j.length) &&delete (this[i]||(this[i]={}))[k];
			} else
				delete this[i];
		},
		fire : function(a, g) {
			var j = b(this, a) || [], i, e = j.length;
			for ( i = 0; i < e; i++)
				j[i].call(null, g);
		}
	};
...
(function(a) {
	...
	function k(c, b, d) {
		var c = c.Env.mods, e, h, b = a.makeArray(b);
		for ( h = 0; h < b.length; h++)
			if ( e = c[b[h]], !e || e.status !== d)
				return 0;
		return 1;
	}

	var g = a.Loader, j = a.Path, l = a.Env.host, e = a.startsWith, f = g.Status, d = f.ATTACHED, h = f.LOADED, c = a.Loader.Utils = {}, m = l.document;
	a.mix(c, {
		docHead : function() {
		...
		normalDepModuleName : function(a, b) {
			...
			if (!b)
				return b;
			if ("string" == typeof b)
				return e(b, "../") || e(b, "./") ? j.resolve(j.dirname(a), b) : j.normalize(b);
			for ( h = b.length; d < h; d++)
				b[d] = c.normalDepModuleName(a, b[d]);
			return b;
		},
		...
		getModules : function(b, e) {
			var h = [b], f, m, g, j, i = b.Env.mods;
			a.each(e, function(e) {
				f = i[e];
				if (!f || "css" != f.getType())
					m = c.unalias(b, e), ( g = a.reduce(m, function(a, c) {
						j = i[c];
		...
		attachModsRecursively : function(a, b, d) {
			var d = d || [], e, h = 1, f = a.length, m = d.length;
			for ( e = 0; e < f; e++)
				h = c.attachModRecursively(a[e], b, d) && h, d.length = m;
			return h;
		},
		...
		normalizeModNames : function(a, b, d) {
			return c.unalias(a, c.normalizeModNamesWithAlias(a, b, d));
		},
		...
		registerModule : function(b, d, e, f) {
			var m = b.Env.mods, g = m[d];
			if (!g || !g.fn)
				c.createModuleInfo(b, d), g = m[d], a.mix(g, {
					name : d,
					status : h,
					fn : e
				}), a.mix(g, f);
		...
		getMappedPath : function(a, c, b) {
			for (var a = b || a.Config.mappedRules || [], d, b = 0; b < a.length; b++)
				if ( d = a[b], c.match(d[0]))
					return c.replace(d[0], d[1]);
			return c;
		}
	});
})(KISSY);
(function(a) {
	...
	var g = a.Path, j = a.Loader, l = j.Utils;
	a.augment(i, {
		getTag : function() {
			return b(this, "tag");
		},
	...
	a.augment(k, {
		...
		getFullPath : function() {
			...
			if (!this.fullpath) {
				...
				b = d.getBaseUri();
				c = this.getPath();
				if (d.isIgnorePackageNameInUri() && ( h = d.getName()))
					c = g.relative(h, c);
				b = b.resolve(c);
		...
		getPackage : function() {
			...
			if (!( b = this.packageInfo)) {
				b = this.runtime;
				var f = this.name, d = b.config("packages"), h = "", c;
		...
		getNormalizedRequires : function() {
			var a, b = this.normalizedRequiresStatus, d = this.status, h = this.requires;
			if (!h || 0 == h.length)
				return h || [];
...
(function(a) {
	function b() {
		for (var l in j) {
			...
			h && (e.callback && e.callback.call(f),
			delete j[l]);
		}
		g = a.isEmptyObject(j) ? 0 : setTimeout(b, i);
	}

	var i = 30, k = a.UA, g = 0, j = {};
...
(function(a) {
	var b = a.Env.host.document, i = a.Loader.Utils, k = a.Path, g = {}, j = 536 > a.UA.webkit;
	a.mix(a, {
		getScript : function(l, e, f) {
			...
			if (1 < d.length)
				return d.node;
			var e = i.docHead(), o = b.createElement( h ? "link" : "script");
...
(function(a, b) {
	...
	var k = a.Loader, g = k.Utils, j = a.Env.host.location, l, e, f = a.Config.fns;
	if (!a.Env.nodejs && j && ( e = j.href))
		l = new a.Uri(e);
	f.map = function(a) {
		var b = this.Config;
	...
	f.packages = function(d) {
		var h, c = this.Config, e = c.packages = c.packages || {};
...
(function(a) {
	var b = a.Loader, i = a.UA, k = b.Utils;
	a.augment(b, b.Target, {
		...
		add : function(b, j, l) {
			...
			if ("string" == typeof b)
				...
				if ( l = j, j = b, i.ie) {
					var b = a.Env.host.document.getElementsByTagName("script"), f, d, h;
...
(function(a, b) {
	...
	function k(a, b, d) {
		var f, m = b.length;
		for ( f = 0; f < m; f++) {
			var j = a, i = b[f], k = d, l = j.runtime, w =
			void 0, A =
			void 0, w = l.Env.mods, y = w[i];
	...
	function g(c, g, j) {
		...
		var k = c.runtime, l = g.getName(), n = g.getCharset(), v = g.getFullPath(), x = 0, w = f.ie, A = "css" == g.getType();
		g.status = h;
	...
	i.prototype = {
		...
		loadModRequires : function(a, b) {
			var c = this.requireLoadedMods, d = b.name;
	...
	a.augment(j, {
		use : function(a, b, c) {
			...
			}), f = this.runtime, a = e.getModNamesAsArray(a), a = e.normalizeModNamesWithAlias(f, a);
			d = e.unalias(f, a);
			k(this, d, h);
...
(function(a, b) {
	...
	function l(b, c) {
		...
		var h = c.modNames, g = c.unaliasModNames, j = c.fn, k, u, v, x, w, A, y, B = b.runtime;
		b.loading = 1;
		k = b.calculate(g);
			...
			for (e in f = 1, d)(function(e) {
				i(d[e], function() {
					a.each(d[e].mods, function(a) {
						return !a.fn ? (a.status = c.ERROR, f = 0, !1) : b;
					});
					f && !--m && h(1);
				}, d[e].charset);
			})(e);
	...
	function d(b, c, h) {
		...
		if (f && !m.isAttached(e, c)) {
			...
			for ( f = 0; f < c.length; f++)
				g = c[f], !m.isLoaded(e, g) && !m.isAttached(e, g) && (j[g] = 1), g = d(b, g, h), a.mix(j, g);
		}
		return j;
	}

	var h = a.Loader, c = h.Status, m = h.Utils;
	...
	a.augment(k, {
		...
		use : function(a, b, c) {
			var d = this, h = d.runtime, a = m.getModNamesAsArray(a), a = m.normalizeModNamesWithAlias(h, a), e = m.unalias(h, a);
		...
		calculate : function(b) {
			var c = {}, h, e, f, g = this.runtime, j = {};
			for ( h = 0; h < b.length; h++)
				e = b[h], m.isAttached(g, e) || (m.isLoaded(g, e) || (c[e] = 1), a.mix(c, d(this, e, j)));
			b = [];
			for (f in c)
			b.push(f);
			return b;
		...
		getComboUrls : function(b) {
			var c = this, d, h = c.runtime, e = h.Config, f = {};
			a.each(b, function(a) {
				var a = c.runtime.Env.mods[a], b = a.getPackage(), d = a.getType(), h, e = b.getName();
				f[e] = f[e] || {};
				if (!( h = f[e][d]))
					h = f[e][d] = f[e][d] || [], h.packageInfo = b;
				h.push(a);
			});
			var g = {
				js : {},
				css : {}
			}, j, i, k, b = e.comboPrefix, l = e.comboSep, A = e.comboMaxFileNum, y = e.comboMaxUrlLength;
			for (i in f)
			for (k in f[i]) {
				j = [];
				var B = f[i][k], D = B.packageInfo, C = ( d = D.getTag()) ? "?t=" + encodeURIComponent(d) : "", I = C.length, z, F, K, J = D.getPrefixUriForCombo();
				g[k][i] = [];
				...
				for ( d = 0; d < B.length; d++)
					if ( F = B[d].getFullPath(), g[k][i].mods.push(B[d]), !D.isCombine() || !a.startsWith(F, J))
						g[k][i].push(F);
					else if ( F = F.slice(J.length).replace(/\?.*$/, ""), j.push(F), j.length > A || K + j.join(l).length + I > y)
						j.pop(), L(), j = [], d--;
				j.length && L();
			}
			return g;
...
(function(a, b) {
	function i() {
		var e = /^(.*)(seed|kissy)(?:-min)?\.js[^/]*/i, f = /(seed|kissy)(?:-min)?\.js/i, d, h, c = g.host.document.getElementsByTagName("script"), m = c[c.length - 1], c = m.src, m = ( m = m.getAttribute("data-config")) ? (new Function("return " + m))() : {};
		d = m.comboPrefix = m.comboPrefix || "??";
		h = m.comboSep = m.comboSep || ",";
		var j, i = c.indexOf(d);
		-1 == i ? j = c.replace(e, "$1") : ( j = c.substring(0, i), "/" != j.charAt(j.length - 1) && (j += "/"), c = c.substring(i + d.length).split(h), a.each(c, function(a) {
			return a.match(f) ? (j += a.replace(e, "$1"), !1) : b;
		}));
		return a.mix({
			base : j
		}, m);
	...
	var k = a.Loader, g = a.Env, j = k.Utils, l = a.Loader.Combo;
...
(function(a, b) {
	...
	var k = a.Env.host, g = a.UA, j = k.document, l = j && j.documentElement, e = k.location, f = new a.Defer, d = f.promise, h = /^#?([\w-]+)$/, c = /\S/, m = !(!j || !j.addEventListener), n = "load", p = m ? function(a, b, c) {
	...
	a.mix(a, {
		...
		available : function(b, c) {
			var b = (b+"").match(h)[1], d = 1, e, f = a.later(function() {
				(( e = j.getElementById(b)) && (c(e) || 1) || 500 < ++d) && f.cancel();
			}, 40, !0);
		}
	});
	if (e && -1 !== (e.search || "").indexOf("ks-debug"))
		a.Config.debug = !0;
	(function() {
		if (!j || "complete" === j.readyState)
			i();
		else if (p(k, n, i), m) {
			var a = function() {
...
(function(a, b, i) {
	...
	a({
		dom : {
			alias : ["dom/base", i.ie && (9 > i.ie || 9 > document.documentMode) ? "dom/ie" : ""]
		}
	});
	a({
		"dom/ie" : {
...
KISSY.add("dom/base/api", function(a) {
	var b = a.Env.host, i = a.UA, k = {
		...
		isCustomDomain : function(a) {
			var a = a || b, g = a.document.domain, a = a.location.hostname;
			return g != a && g != "[" + a + "]";
		},
		getEmptyIframeSrc : function(a) {
			a = a || b;
			return i.ie && g.isCustomDomain(a) ? "javascript:void(function(){" + encodeURIComponent("document.open();document.domain='" + a.document.domain + "';document.close();") + "}())" : "";
		},
		NodeType : k,
		...
		nodeName : function(a) {
			var b = g.get(a), a = b.nodeName.toLowerCase();
...
KISSY.add("dom/base/attr", function(a, b, i) {
	...
	var g = a.Env.host.document, j = b.NodeType, l = ( g = g && g.documentElement) && g.textContent === i ? "innerText" : "textContent", e = b.nodeName, f = /^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i, d = /^(?:button|input|object|select|textarea)$/i, h = /^a(?:rea)?$/i, c = /:|^on/, m = /\r/g, n = {}, p = {
		val : 1,
		css : 1,
		html : 1,
		text : 1,
		...
		select : {
			get : function(a) {
				var c = a.selectedIndex, d = a.options, h;
				if (0 > c)
					return null;
	...
	a.each(["radio", "checkbox"], function(c) {
		u[c] = {
			...
			set : function(c, d) {
				if (a.isArray(d))
					return c.checked = a.inArray(b.val(c), d);
			}
		};
	});
	o.style = {
	...
	a.mix(b, {
		...
		prop : function(c, d, h) {
			...
			if (h !== i)
				for ( c = e.length - 1; 0 <= c; c--)
					f = e[c], m && m.set ? m.set(f, h, d) : f[d] = h;
			else if (e.length)
				return k(e[0], d);
			return i;
		},
		hasProp : function(a, c) {
			var d = b.query(a), h, e = d.length, f;
			for ( h = 0; h < e; h++)
				if ( f = d[h], k(f, c) !== i)
					return !0;
			return !1;
		...
		attr : function(d, h, m, g) {
			...
			if (m === i) {
				...
				for ( g = k.length - 1; 0 <= g; g--)
					if (( l = k[g]) && l.nodeType === j.ELEMENT_NODE)
						"form" == e(l) && ( d = s), d && d.set ? d.set(l, m, h) : l.setAttribute(h, "" + m);
			return i;
		},
		removeAttr : function(a, c) {
			var c = c.toLowerCase(), c = n[c] || c, d = b.query(a), h, e, m;
			for ( m = d.length - 1; 0 <= m; m--)
				if ( e = d[m], e.nodeType == j.ELEMENT_NODE && (e.removeAttribute(c), f.test(c) && ( h = q[c] || c) in e))
					e[h] = !1;
		},
		hasAttr : g && !g.hasAttribute ? function(a, c) {
			var c = c.toLowerCase(), d = b.query(a), h, e;
			for ( h = 0; h < d.length; h++)
				if ( e = d[h], ( e = e.getAttributeNode(c)) && e.specified)
					return !0;
			return !1;
		} : function(a, c) {
			var d = b.query(a), h, e = d.length;
			for ( h = 0; h < e; h++)
				if (d[h].hasAttribute(c))
					return !0;
			return !1;
		},
		val : function(c, d) {
			...
			if (d === i) {
				if ( g = b.get(c)) {
					if (( h = u[e(g)] || u[g.type]) && "get" in h && ( f = h.get(g, "value")) !== i)
						return f;
					f = g.value;
					return "string" === typeof f ? f.replace(m, "") : null == f ? "" : f;
				}
				return i;
			}
			f = b.query(c);
			for ( j = f.length - 1; 0 <= j; j--) {
				...
				h = u[e(g)] || u[g.type];
				if (!h || !("set" in h) || h.set(g, k, "value") === i)
					g.value = k;
			}
			return i;
		},
		text : function(a, c) {
			...
			if (c === i) {
				d = b.get(a);
				if (d.nodeType == j.ELEMENT_NODE)
					return d[l] || "";
				if (d.nodeType == j.TEXT_NODE)
					return d.nodeValue;
			} else {
				h = b.query(a);
				for ( e = h.length - 1; 0 <= e; e--)
					d = h[e], d.nodeType == j.ELEMENT_NODE ? d[l] = c : d.nodeType == j.TEXT_NODE && (d.nodeValue = c);
			}
			return i;
		}
	});
...
KISSY.add("dom/base/class", function(a, b, i) {
	function k(e, f, d, h) {
		if (!( f = a.trim(f)))
			return h ? !1 : i;
		var e = b.query(e), c = e.length, m = f.split(j), f = [], k, l;
		for ( l = 0; l < m.length; l++)
			( k = a.trim(m[l])) && f.push(k);
		for ( l = 0; l < c; l++)
			if ( m = e[l], m.nodeType == g.ELEMENT_NODE && ( m = d(m, f, f.length), m !== i))
				return m;
		return h ? !1 : i;
	}

	var g = b.NodeType, j = /[\.\s]\s*\.?/, l = /[\n\t]/g;
	a.mix(b, {
		hasClass : function(a, b) {
			return k(a, b, function(a, b, c) {
				var a = a.className, e, f;
				if (a) {
					a = (" " + a + " ").replace(l, " ");
					e = 0;
					for ( f = !0; e < c; e++)
		...
		addClass : function(b, f) {
			k(b, f, function(b, h, c) {
				var e = b.className, g, i;
				if (e) {
					g = (" " + e + " ").replace(l, " ");
					for ( i = 0; i < c; i++)
						0 > g.indexOf(" " + h[i] + " ") && (e += " " + h[i]);
		...
		removeClass : function(b, f) {
			k(b, f, function(b, h, c) {
				var e = b.className, f, g;
				if (e)
					if (c) {
						e = (" " + e + " ").replace(l, " ");
						for ( f = 0; f < c; f++)
							for ( g = " " + h[f] + " "; 0 <= e.indexOf(g); )
								e = e.replace(g, " ");
						b.className = a.trim(e);
					} else
						b.className = "";
		...
		replaceClass : function(a, f, d) {
			b.removeClass(a, f);
			b.addClass(a, d);
		},
		toggleClass : function(e, f, d) {
			var h = a.isBoolean(d), c, g;
			k(e, f, function(a, e, i) {
				for ( g = 0; g < i; g++)
					f = e[g], c = h ? !d : b.hasClass(a, f), b[c?"removeClass":"addClass"](a, f);
			}, i);
		}
	});
	return b;
...
KISSY.add("dom/base/create", function(a, b, i) {
	...
	var f = a.Env.host.document, d = b.NodeType, h = a.UA.ie, c = "div", m = f && f.createElement(c), n = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig, p = /<([\w:]+)/, o = /^\s+/, q = h && 9 > h, r = /<|&#?\w+;/, t = f && "outerHTML" in f.documentElement, s = /^<(\w+)\s*\/?>(?:<\/\1>)?$/;
	a.mix(b, {
		create : function(h, m, j, k) {
			...
			k === i && ( k = !0);
			k && ( h = a.trim(h));
			var k = b._creators, t, u, j = j || f, w, v = c;
			if (r.test(h))
				if ( w = s.exec(h))
					l = j.createElement(w[1]);
				else {
					h = h.replace(n, "<$1></$2>");
					if (( w = p.exec(h)) && ( t = w[1]))
						v = t.toLowerCase();
		...
		html : function(a, c, h, e) {
			var a = b.query(a), f = a[0], g = !1, m, j;
			if (f) {
				if (c === i)
					return f.nodeType == d.ELEMENT_NODE ? f.innerHTML : null;
				c += "";
				if (!c.match(/<(?:script|style|link)/i) && (!q || !c.match(o)) && !x[(c.match(p)||
					["",""])[1].toLowerCase()])
					try {
						for ( m = a.length - 1; 0 <= m; m--)
							j = a[m], j.nodeType == d.ELEMENT_NODE && (k(j.getElementsByTagName("*")), j.innerHTML = c);
						g = !0;
					} catch(l) {
					}
		...
		outerHTML : function(a, h, e) {
			...
			if ( a = g[0]) {
				...
				if (!h.match(/<(?:script|style|link)/i) && t)
					for ( e = j - 1; 0 <= e; e--)
						a = g[e], a.nodeType == d.ELEMENT_NODE && (k(a), k(a.getElementsByTagName("*")), a.outerHTML = h);
				else
					a = b.create(h, 0, a.ownerDocument, 0), b.insertBefore(a, g, e), b.remove(g);
			}
		},
		remove : function(a, c) {
			var h, e = b.query(a), f, g;
			for ( g = e.length - 1; 0 <= g; g--)
				h = e[g], !c && h.nodeType == d.ELEMENT_NODE && ( f = h.getElementsByTagName("*"), k(f), k(h)), h.parentNode && h.parentNode.removeChild(h);
		},
		clone : function(a, c, h, e) {
			"object" === typeof c && ( e = c.deepWithDataAndEvent, h = c.withDataAndEvent, c = c.deep);
			var a = b.get(a), f, g = b._fixCloneAttributes, m;
			if (!a)
				return null;
			m = a.nodeType;
			f = a.cloneNode(c);
			if (m == d.ELEMENT_NODE || m == d.DOCUMENT_FRAGMENT_NODE)
				g && m == d.ELEMENT_NODE && g(a, f), c && g && j(g, a, f);
			h && (l(a, f), c && e && j(l, a, f));
			return f;
		},
		empty : function(a) {
			...
			for ( d = a.length - 1; 0 <= d; d--)
				c = a[d], b.remove(c.childNodes);
		},
		_nodeListToFragment : e
	});
	var u = b._creators, v = b.create, x = {
		option : "select",
		optgroup : "select",
		area : "map",
		thead : "table",
...
KISSY.add("dom/base/data", function(a, b, i) {
	var k = a.Env.host, g = "__ks_data_" + a.now(), j = {}, l = {}, e = {
		applet : 1,
		object : 1,
		embed : 1
	}, f = {
		...
		data : function(a, b, h) {
			...
			if (h !== i)
				...
				return b !== i ? e && e[b] : e = a[g] = a[g] || {};
		},
		removeData : function(b, h) {
			if (b == k)
				return d.removeData(l, h);
			var e = b[g];
			if (h !== i)
				delete e[h], a.isEmptyObject(e) && d.removeData(b);
			else
				try {
					delete b[g];
				} catch(f) {
		...
		data : function(b, d, h) {
			...
			if (h !== i)
				...
				return d !== i ? b && b[d] : b = j[f] = j[f] || {};
		},
		removeData : function(b, d) {
			var e = b[g], f;
			if (e)
				if ( f = j[e], d !== i)
					delete f[d], a.isEmptyObject(f) && h.removeData(b);
				else {
					delete j[e];
					try {
						delete b[g];
	...
	a.mix(b, {
		...
		data : function(c, e, f) {
			...
			if (f === i) {
				if (g)
					return g.nodeType ? h.data(g, e) : d.data(g, e);
			} else
				for ( j = c.length - 1; 0 <= j; j--)
					g = c[j], g.nodeType ? h.data(g, e, f) : d.data(g, e, f);
			return i;
		},
		removeData : function(a, e) {
			var f = b.query(a), g, j;
			for ( j = f.length - 1; 0 <= j; j--)
				g = f[j], g.nodeType ? h.removeData(g, e) : d.removeData(g, e);
		}
	});
	return b;
}, {
...
KISSY.add("dom/base/insertion", function(a, b) {
	function i(a, b) {
		var g = [], k, o, q;
		for ( k = 0; a[k]; k++)
			if ( o = a[k], q = e(o), o.nodeType == j.DOCUMENT_FRAGMENT_NODE)
				g.push.apply(g, i(f(o.childNodes), b));
			else if ("script" === q && (!o.type || h.test(o.type)))
				o.parentNode && o.parentNode.removeChild(o), b && b.push(o);
			else {
				if (o.nodeType == j.ELEMENT_NODE && !l.test(q)) {
					q = [];
					var r, t, s = o.getElementsByTagName("script");
					for ( t = 0; t < s.length; t++)
						r = s[t], (!r.type || h.test(r.type)) && q.push(r);
	...
	function g(c, d, h, e) {
		...
		var d = b.query(d), f, g, j, l, s = d.length;
		if ((c.length || e && e.length) && s) {
			c = b._nodeListToFragment(c);
			1 < s && ( l = b.clone(c, !0), d = a.makeArray(d));
			for ( f = 0; f < s; f++)
				g = d[f], c && ( j = 0 < f ? b.clone(l, !0) : c, h(j, g)), e && e.length && a.each(e, k);
		}
	}

	var j = b.NodeType, l = /^(?:button|input|object|select|textarea)$/i, e = b.nodeName, f = a.makeArray, d = [].splice, h = /\/(java|ecma)script/i;
	a.mix(b, {
		...
		wrapAll : function(a, d) {
			d = b.clone(b.get(d), !0);
			a = b.query(a);
			a[0].parentNode && b.insertBefore(d, a[0]);
			for (var h; ( h = d.firstChild) && 1 == h.nodeType; )
				d = h;
			b.appendTo(a, d);
		},
		wrap : function(c, d) {
...
KISSY.add("dom/base/offset", function(a, b, i) {
	...
	var j = a.Env.host, l = j.document, e = b.NodeType, f = l && l.documentElement, d = b.getWindow, h = Math.max, c = parseFloat, m = "ownerDocument", n = "left", p = "top", o = a.isNumber, q = "scrollLeft", r = "scrollTop";
	a.mix(b, {
		...
		scrollIntoView : function(h, f, g, j) {
			...
			if ( l = b.get(h)) {
				...
				j = j === i ? !0 : j;
				m = !!d(f);
				var h = b.offset(l), q = b.outerHeight(l);
				k = b.outerWidth(l);
				var r, C, I, z;
				...
				if (o) {
					if (0 > l || 0 < h)
						!0 === g ? b.scrollTop(f, z.top + l) : !1 === g ? b.scrollTop(f, z.top + h) : 0 > l ? b.scrollTop(f, z.top + l) : b.scrollTop(f, z.top + h);
				} else
					( g = g === i ? !0 : !!g) ? b.scrollTop(f, z.top + l) : b.scrollTop(f, z.top + h);
				if (j)
					if (o) {
						if (0 > m || 0 < k)
							!0 === g ? b.scrollLeft(f, z.left + m) : !1 === g ? b.scrollLeft(f, z.left + k) : 0 > m ? b.scrollLeft(f, z.left + m) : b.scrollLeft(f, z.left + k);
					} else
						( g = g === i ? !0 : !!g) ? b.scrollLeft(f, z.left + m) : b.scrollLeft(f, z.left + k);
			}
		},
		docWidth : 0,
		docHeight : 0,
	...
	a.each(["Left", "Top"], function(a, c) {
		...
		b[h] = function(f, g) {
			if (o(f))
				return arguments.callee(j, f);
			var f = b.get(f), m, k, l, n = d(f);
			n ? g !== i ? ( g = parseFloat(g), k = "Left" == a ? g : b.scrollLeft(n), l = "Top" == a ? g : b.scrollTop(n), n.scrollTo(k, l)) : ( m = n["page" + ( c ? "Y" : "X") + "Offset"], o(m) || ( k = n.document, m = k.documentElement[h], o(m) || ( m = k.body[h]))) : f.nodeType == e.ELEMENT_NODE && (g !== i ? f[h] = parseFloat(g) : m = f[h]);
			return m;
		};
	});
	a.each(["Width", "Height"], function(a) {
		...
		b["viewport" + a] = function(c) {
			var c = b.get(c), h = "client" + a, c = d(c).document, e = c.body, f = c.documentElement[h];
...
KISSY.add("dom/base/selector", function(a, b, i) {
	...
	function g(d, h) {
		var e, f, m = "string" == typeof d, o = h === i && ( f = 1) ? [c] : g(h);
	...
	function j(b, c) {
		...
		if (d && b.match(w) || !d)
			...
			var d = [], h, f = b.split(/\s*,\s*/);
			for ( h = 0; h < f.length; h++)
				t.apply(d, j(f[h], c));
		} else
			d = [], ( h = a.require("sizzle")) && h(b, c, d);
		return d;
	}
	...
	function l(a, c) {
		...
		if (x.test(a))
			...
			g = g[3];
			if ( c = e ? f(e, c) : c)
				g ? !e || -1 != a.indexOf(s) ? h = [].concat(b._getElementsByClassName(g, j, c)) : ( e = f(e, c), d(e, g) && ( h = [e])) : j && ( h = o(b._getElementsByTagName(j, c)));
			h = h || [];
		}
		return h;
	}
	...
	var c = a.Env.host.document, m = b.NodeType, n = a.filter, p = a.isArray, o = a.makeArray, q = b._isNodeList, r = b.nodeName, t = Array.prototype.push, s = " ", u = ",", v = a.trim, x = /^#[\w-]+$/, w = /^(?:#([\w-]+))?\s*([\w-]+|\*)?\.?([\w-]+)?$/;
	a.mix(b, {
		_getAttr : h,
		_hasSingleClass : d,
		_getElementById : function(a, c, d, h) {
			var e = d.getElementById(a), f = b._getAttr(e, "id");
		...
		unique : function() {
			...
			return function(b) {
				...
				b.sort(a);
				if (c)
					for (var h = 1, e = b.length; h < e; )
						b[h] === b[h - 1] ? b.splice(h, 1) : h++;
				return b;
			};
		}(),
		filter : function(b, c, e) {
			var b = g(b, e), e = a.require("sizzle"), f, j, i, m, k = [];
			if ("string" == typeof c && ( c = v(c)) && ( f = w.exec(c)))
				i = f[1], j = f[2], m = f[3], i ? i && !j && !m && ( c = function(a) {
					return h(a, "id") == i;
				}) : c = function(a) {
					var b = !0, c = !0;
...
KISSY.add("dom/base/style", function(a, b, i) {
	...
	function j(a, b, c) {
		var d, h, e;
		if (3 === a.nodeType || 8 === a.nodeType || !( d = a[m]))
			return i;
		b = k(b);
		e = A[b];
		b = y[b] || b;
	...
	function e(c, d, h) {
		if (a.isWindow(c))
			return d == p ? b.viewportWidth(c) : b.viewportHeight(c);
		if (9 == c.nodeType)
			return d == p ? b.docWidth(c) : b.docHeight(c);
		var e = d === p ? ["Left", "Right"] : ["Top", "Bottom"], f = d === p ? c.offsetWidth : c.offsetHeight;
		if (0 < f)
			return "border" !== h && a.each(e, function(a) {
	...
	var f = a.Env.host, d = a.UA, h = b.nodeName, c = f.document, m = "style", n = /^margin/, p = "width", o = "display" + a.now(), q = parseInt, r = {
		fillOpacity : 1,
		fontWeight : 1,
		lineHeight : 1,
		opacity : 1,
	...
	a.mix(b, {
		...
		_getComputedStyle : function(a, c) {
			...
			if ( h = e.defaultView.getComputedStyle(a, null))
				d = h.getPropertyValue(c) || h[c];
			"" === d && !b.contains(e, a) && ( c = y[c] || c, d = a[m][c]);
			b._RE_NUM_NO_PX.test(d) && n.test(c) && ( j = a.style, e = j.width, f = j.minWidth, g = j.maxWidth, j.minWidth = j.maxWidth = j.width = d, d = h.width, j.width = e, j.minWidth = f, j.maxWidth = g);
			return d;
		},
		style : function(c, d, h) {
			var c = b.query(c), e, f = c[0];
			if (a.isPlainObject(d)) {
				for (e in d)
				for ( f = c.length - 1; 0 <= f; f--)
					j(c[f], e, d[e]);
			...
			if (h === i)
				return e = "", f && ( e = j(f, d, h)), e;
			for ( f = c.length - 1; 0 <= f; f--)
				j(c[f], d, h);
			return i;
		},
		css : function(c, d, h) {
			var c = b.query(c), e = c[0], f;
			if (a.isPlainObject(d)) {
				for (f in d)
			...
			if (h === i) {
				h = "";
				if (e && (!f || !("get" in f && ( h = f.get(e, !0)) !== i)))
					h = b._getComputedStyle(e, d);
				return h === i ? "" : h;
			}
			for ( e = c.length - 1; 0 <= e; e--)
				j(c[e], d, h);
		...
		toggle : function(a) {
			var a = b.query(a), c, d;
			for ( d = a.length - 1; 0 <= d; d--)
				c = a[d], "none" === b.css(c, "display") ? b.show(c) : b.hide(c);
		},
		addStyleSheet : function(a, c, d) {
			a = a || f;
			"string" == typeof a && ( d = c, c = a, a = f);
			var a = b.get(a), a = b.getWindow(a).document, h;
			if (d && ( d = d.replace("#", x)))
				h = b.get("#" + d, a);
			h || ( h = b.create("<style>", {
				id : d
			}, a), b.get("head", a).appendChild(h), h.styleSheet ? h.styleSheet.cssText = c : h.appendChild(a.createTextNode(c)));
		},
		unselectable : function(c) {
			var c = b.query(c), e, f, g = 0, j, i;
			for ( f = c.length - 1; 0 <= f; f--)
				if ( e = c[f], d.gecko)
					e[m].MozUserSelect = "none";
				else if (d.webkit)
					e[m].KhtmlUserSelect = "none";
				else if (d.ie || d.opera) {
					i = e.getElementsByTagName("*");
					e.setAttribute("unselectable", "on");
					for ( j = ["iframe", "textarea", "input", "select"]; e = i[g++]; )
						a.inArray(h(e), j) || e.setAttribute("unselectable", "on");
				}
		},
		innerWidth : 0,
		innerHeight : 0,
	...
	a.each(["left", "top"], function(h) {
		A[h] = {
			get : function(e, f) {
				var g;
				if (f && ( g = b._getComputedStyle(e, h), "auto" === g)) {
					g = 0;
					if (a.inArray(b.css(e, "position"), ["absolute", "fixed"])) {
						g = e["left" === h ? "offsetLeft" : "offsetTop"];
						if (d.ie && 9 > (c.documentMode || 0) || d.opera)
							g -= e.offsetParent && e.offsetParent["client" + ("left" == h ? "Left" : "Top")] || 0;
	...
	function j(e, f, d, h) {
		...
		if (g) {
			...
			for ( g = 0; g < d.length; g++)
				j = d[g], (h || j.nodeType == l.ELEMENT_NODE) && j != e && c.push(j);
			f && ( c = b.filter(c, f));
		}
		return c;
	}
...
KISSY.add("dom/ie/attr", function(a, b) {
	var i = b._attrHooks, k = b._attrNodeHook, g = b.NodeType, j = b._valHooks, l = b._propFix;
	if (8 > (document.documentMode || a.UA.ie))
		i.style.set = function(a, b) {
			a.style.cssText = b;
		}, a.mix(k, {
			get : function(a, b) {
		...
		}), a.mix(b._attrFix, l), i.tabIndex = i.tabindex, a.each("href,src,width,height,colSpan,rowSpan".split(","), function(a) {
			i[a] = {
				get : function(b) {
	...
	(i.href = i.href || {}).set = function(a, b, d) {
		for (var h = a.childNodes, c, j = h.length, i = 0 < j, j = j - 1; 0 <= j; j--)
			h[j].nodeType != g.TEXT_NODE && ( i = 0);
...
KISSY.add("dom/ie/create", function(a, b) {
	...
	b._fixCloneAttributes = function(a, e) {
		...
		var f = e.nodeName.toLowerCase(), d = a.childNodes;
		if ("object" === f && !e.childNodes.length)
			for ( f = 0; f < d.length; f++)
				e.appendChild(d[f].cloneNode(!0));
		else if ("input" === f && ("checkbox" === a.type || "radio" === a.type)) {
			if (a.checked && (e.defaultChecked = e.checked = a.checked), e.value !== a.value)
				e.value = a.value;
		} else if ("option" === f)
	...
	var k = b._creators, g = b._defaultCreator, j = /<tbody/i;
	8 > i && (k.table = function(i, e) {
		var f = g(i, e);
		if (j.test(i))
			return f;
		var d = f.firstChild, h = a.makeArray(d.childNodes);
		a.each(h, function(a) {
...
KISSY.add("dom/ie/input-selection", function(a, b) {
	function i(a, b) {
		var d = 0, h = 0, c = a.ownerDocument.selection.createRange(), g = k(a);
	...
	function g(a, b, d) {
		var h = Math.min(b, d), c = Math.max(b, d);
		return h == c ? 0 : "textarea" == a.type ? ( a = a.value.substring(h, c).replace(/\r\n/g, "\n").length, b > d && ( a = -a), a) : d - b;
	}

	function j(a, b) {
		if ("textarea" == a.type) {
			var d = b.text, h = b.duplicate();
			if (0 == h.compareEndPoints("StartToEnd", h))
				return d;
...
KISSY.add("dom/ie/insertion", function(a, b) {
	if (8 > (document.documentMode || a.UA.ie))
		b._fixInsertionChecked = function k(a) {
			for (var j = 0; j < a.length; j++) {
				...
				if (l.nodeType == b.NodeType.DOCUMENT_FRAGMENT_NODE)
					...
					for (var l = l.getElementsByTagName("input"), e = 0; e < l.length; e++)
						k(l[e]);
			}
		};
}, {
...
KISSY.add("dom/ie/selector", function(a, b) {
	...
	i.querySelectorAll || (b._getElementsByClassName = function(a, g, j) {
		if (!j)
			return [];
		for (var g = j.getElementsByTagName(g || "*"), j = [], i = 0, e = 0, f = g.length, d; i < f; ++i)
			d = g[i], b._hasSingleClass(d, a) && (j[e++] = d);
		return j;
	});
	b._getElementsByTagName = function(b, g) {
		var j = a.makeArray(g.getElementsByTagName(b)), i, e, f, d;
		if (b === "*") {
			i = [];
			for ( f = e = 0; d = j[e++]; )
				d.nodeType === 1 && (i[f++] = d);
...
KISSY.add("dom/ie/style", function(a, b) {
	var i = b._cssProps, k = document.documentMode || a.UA.ie, g = a.Env.host.document, g = g && g.documentElement, j = /^(top|right|bottom|left)$/, l = b._CUSTOM_STYLES, e = /opacity\s*=\s*([^)]*)/, f = /alpha\([^)]*\)/i;
	i["float"] = "styleFloat";
	...
	try {
		null == g.style.opacity && (l.opacity = {
			...
			set : function(b, d) {
				var d = parseFloat(d), h = b.style, e = b.currentStyle, g = isNaN(d) ? "" : "alpha(opacity=" + 100 * d + ")", j = a.trim(e && e.filter || h.filter || "");
				h.zoom = 1;
				if ((1 <= d || !g) && !a.trim(j.replace(f, "")))
					if (h.removeAttribute("filter"), !g || e && !e.filter)
						return;
	...
	a.each(["", "Top", "Left", "Right", "Bottom"], function(a) {
		var b = "border" + a + "Width", d = "border" + a + "Style";
		l[b] = {
			get : function(a, c) {
				var f = c ? a.currentStyle : 0, e = f && "" + f[b] ||
				void 0;
	...
	b._getComputedStyle = function(a, d) {
		var d = i[d] || d, h = a.currentStyle && a.currentStyle[d];
		if (b._RE_NUM_NO_PX.test(h) && !j.test(d)) {
			var e = a.style, f = e.left, g = a.runtimeStyle.left;
...
KISSY.add("event/base/observable", function(a) {
	...
	b.prototype = {
		...
		removeObserver : function(a) {
			var b, g = this.observers, j = g.length;
			for ( b = 0; b < j; b++)
				if (g[b] == a) {
					g.splice(b, 1);
					break;
...
KISSY.add("event/base/observer", function(a) {
	...
	b.prototype = {
		...
		notify : function(a, b) {
			var g;
			g = a._ks_groups;
			if (!g || this.groups && this.groups.match(g))
				return g = this.notifyInternal(a, b), !1 === g && a.halt(), g;
		}
	};
	return b;
});
KISSY.add("event/base/utils", function(a) {
	...
	return {
		splitAndRun : i = function(b, g) {
			b = a.trim(b);
			-1 == b.indexOf(" ") ? g(b) : a.each(b.split(/\s+/), g);
		},
		normalizeParam : function(i, g, j) {
			var l = g || {}, l = a.isFunction(g) ? {
				fn : g,
				context : j
			} : a.merge(l), g = b(i), i = g[0];
			l.groups = g[1];
			l.type = i;
			return l;
		},
...
KISSY.add("event/custom/api-impl", function(a, b, i, k) {
	var g = a.trim, j = i._Utils, l = j.splitAndRun;
	return a.mix(b, {
		fire : function(a, b, d) {
			var h =
			void 0, d = d || {};
		...
		removeTarget : function(e, f) {
			var d = b.getTargets(e), h = a.indexOf(f, d);
			-1 != h && d.splice(h, 1);
			return e;
		},
		...
		detach : function(b, f, d, h) {
			...
			j.batchForType(function(c, d, h) {
				...
				( c = f.type) ? ( c = k.getCustomEvent(b, c, 1)) && c.detach(f) : ( c = k.getCustomEvents(b), a.each(c, function(a) {
					a.detach(f);
				}));
			}, 0, f, d, h);
			return b;
...
KISSY.add("event/custom/observable", function(a, b, i, k, g) {
	...
	a.extend(j, g._ObservableEvent, {
		...
		checkMemory : function() {
			var b = this.currentTarget, d = j.getCustomEvents(b);
			d && (this.hasObserver() ||
			delete d[this.type], a.isEmptyObject(d) &&
			delete b[e]);
		},
		fire : function(a) {
			if (this.hasObserver() || this.bubbles) {
				var a = a || {}, d = this.type, h = this.defaultFn, c, e, g;
				...
				if (this.bubbles) {
					...
					for ( c = 0; c < g && !i.isPropagationStopped(); c++)
						a = b.fire(e[c], d, i), !1 !== l && ( l = a);
				}
		...
		notify : function(a) {
			var b = this.observers, h, c, e = b.length, g;
			for ( g = 0; g < e && !a.isImmediatePropagationStopped(); g++)
				h = b[g].notify(a, this), !1 !== c && ( c = h), !1 === h && a.halt();
			return c;
		},
		detach : function(a) {
			var b, h = a.fn, c = a.context, e = this.currentTarget, g = this.observers, a = a.groups;
			if (g.length) {
				a && ( b = l.getGroupsRe(a));
				...
				if (h || b) {
					...
					j = a = 0;
					for ( i = []; a < t; ++a)
						if ( k = g[a], r = k.context || e, c != r || h && h != k.fn || b && !k.groups.match(b))
							i[j++] = k;
					this.observers = i;
				} else
					this.reset();
	...
	j.getCustomEvent = function(a, b, h) {
...
KISSY.add("event/dom/base/api", function(a, b, i, k, g, j, l) {
	...
	function f(b, c, d) {
		var f, g, i, d = a.merge(d), c = e(d, c);
		f = j.getCustomEvents(b, 1);
		if (!( i = f.handle))
			i = f.handle = function(a) {
				var b = a.type, c = i.currentTarget;
				if (!(j.triggeredEvent == b || "undefined" == typeof KISSY))
					if ( b = j.getCustomEvent(c, b))
		...
		remove : function(b, c, f, g) {
			...
			d.batchForType(function(b, c, h, f) {
				...
				for ( f = b.length - 1; 0 <= f; f--) {
					var g = b[f], i = c, k = h, k = a.merge(k), l =
					void 0, i = e(k, i), g = j.getCustomEvents(g), l = (g || {}).events;
					if (g && l)
						if (i)
							( l = l[i]) && l.detach(k);
						else
		...
		fire : function(b, c, e, f) {
			...
			d.splitAndRun(c, function(c) {
				...
				for ( l = b.length - 1; 0 <= l; l--)
					k = b[l], t = j.getCustomEvent(k, c), !f && !t && ( t = new j({
						type : c,
						currentTarget : k
...
KISSY.add("event/dom/base/key-codes", function(a) {
	var b = a.UA, i = {
		...
		isTextModifyingKeyEvent : function(a) {
			if (a.altKey && !a.ctrlKey || a.metaKey || a.keyCode >= i.F1 && a.keyCode <= i.F12)
				return !1;
			switch(a.keyCode) {
				case i.ALT:
				case i.CAPS_LOCK:
		...
		isCharacterKey : function(a) {
			if (a >= i.ZERO && a <= i.NINE || a >= i.NUM_ZERO && a <= i.NUM_MULTIPLY || a >= i.A && a <= i.Z || b.webkit && 0 == a)
				return !0;
			switch(a) {
				case i.SPACE:
	...
	a.each([{
		...
		k[a.name] = {
			...
			handle : function(a, b, e) {
				...
				if (!d || d !== f && !i.contains(f, d))
					return [b.simpleNotify(a, e)];
			}
		};
	});
	return b;
...
KISSY.add("event/dom/base/object", function(a, b, i) {
	...
	function g(a) {
		for (var b = a.originalEvent, e = d.length, f, g = b.currentTarget, g = 9 === g.nodeType ? g : g.ownerDocument || l; e; )
			f = d[--e], a[f] = b[f];
		...
		!a.which && a.button !== i && (a.which = a.button & 1 ? 1 : a.button & 2 ? 3 : a.button & 4 ? 2 : 0);
	}
...
KISSY.add("event/dom/base/observable", function(a, b, i, k, g, j, l) {
	...
	a.extend(e, l._ObservableEvent, {
		setup : function() {
			var a = this.type, b = i[a] || {}, c = this.currentTarget, e = k.data(c).handle;
		...
		notify : function(a) {
			var h = a.target, c = this.currentTarget, e = this.observers, f = [], g, j, i = this.delegateCount || 0, l, k;
			if (i && !h.disabled)
				for (; h != c; ) {
					l = [];
					for ( j = 0; j < i; j++)
						k = e[j], b.test(h, k.selector) && l.push(k);
					l.length && f.push({
						currentTarget : h,
			...
			for ( h = f.length; !a.isPropagationStopped() && j < h; ++j) {
				...
				c = c.currentTarget;
				a.currentTarget = c;
				for ( c = 0; !a.isImmediatePropagationStopped() && c < l.length; c++)
					e = l[c], e = e.notify(a, this), !1 !== g && ( g = e);
			}
			return g;
		},
		fire : function(d, h) {
			var d = d || {}, c = this.type, f = i[c];
			f && f.onFix && ( c = f.onFix);
			var g, l, f = this.currentTarget, k = !0;
			d.type = c;
			...
			var q = g.document, r = [], t = 0, s = "on" + c;
			do r.push(l), l = l.parentNode || l.ownerDocument || l === q && g;
			while(l);
			l = r[t];
			do {
				d.currentTarget = l;
				if ( g = e.getCustomEvent(l, c))
					g = g.notify(d), !1 !== k && ( k = g);
			...
			if (!h && !d.isDefaultPrevented()) {
				var u;
				try {
					if (s && f[c] && ("focus" !== c && "blur" !== c || 0 !== f.offsetWidth) && !a.isWindow(f))
						( u = f[s]) && (f[s] = null), e.triggeredEvent = c, f[c]();
				} catch(v) {
				}
				u && (f[s] = u);
				e.triggeredEvent = "";
		...
		on : function(a) {
			var b = this.observers, c = i[this.type] || {}, a = a instanceof g ? a : new g(a);
			-1 == this.findObserver(a) && (a.selector ? (b.splice(this.delegateCount, 0, a), this.delegateCount++) : a.last ? (b.push(a), this.lastCount++) : b.splice(b.length - this.lastCount, 0, a), c.add && c.add.call(this.currentTarget, a));
		},
		detach : function(a) {
			var b, c = i[this.type] || {}, e = "selector" in a, g = a.selector, j = a.context, l = a.fn, k = this.currentTarget, r = this.observers, a = a.groups;
			if (r.length) {
				a && ( b = f.getGroupsRe(a));
				...
				if (l || e || b) {
					...
					t = a = 0;
					for ( s = []; a < x; ++a)
						u = r[a], v = u.context || k, j != v || l && l != u.fn || e && (g && g != u.selector || !g && !u.selector) || b && !u.groups.match(b) ? s[t++] = u : (u.selector && this.delegateCount && this.delegateCount--, u.last && this.lastCount && this.lastCount--, c.remove && c.remove.call(k, u));
					this.observers = s;
				} else
					this.reset();
				this.checkMemory();
		...
		checkMemory : function() {
			var b = this.type, h, c, e = i[b] || {}, f = this.currentTarget, g = k.data(f);
			if (g && ( h = g.events, this.hasObserver() || ( c = g.handle, (!e.tearDown || !1 === e.tearDown.call(f, b)) && k.simpleRemove(f, b, c),
				delete h[b]), a.isEmptyObject(h)))
				g.handle = null, k.removeData(f);
		}
	});
	e.triggeredEvent = "";
...
KISSY.add("event/dom/base/utils", function(a, b) {
	...
	return {
		...
		removeData : function(a) {
			return b.removeData(a, "ksEventTargetId_1.30");
		}
	};
}, {
	requires : ["dom"]
...
KISSY.add("event/dom/base/valuechange", function(a, b, i, k) {
	...
	var c = "valuechange", m = i.nodeName, n = "event/valuechange/history", p = "event/valuechange/poll", o = 50;
	k[c] = {
		setup : function() {
			var a = m(this);
			if ("input" == a || "textarea" == a)
				h(this), b.on(this, "blur", j), b.on(this, "webkitspeechchange", d), b.on(this, "mousedown keyup keydown focus", f);
		},
		tearDown : function() {
			h(this);
		}
...
KISSY.add("event/dom/hashchange", function(a, b, i) {
	var k = a.UA, g = b._Special, j = a.Env.host, l = j.document, e = l && l.documentMode, f = "__replace_history_" + a.now(), k = e || k.ie;
	b.REPLACE_HISTORY = f;
	var d = "<html><head><title>" + (l && l.title || "") + " - {hash}</title>{head}</head><body>{hash}</body></html>", h = function() {
	...
	k && 8 > k && ( o = function() {
		if (!r) {
			...
			var d = function() {
				var c = a.trim(r.contentWindow.document.body.innerText), d = h();
	...
	b._Special.change = {
		setup : function() {
			if (f.test(this.nodeName))
				if (k(this))
					b.on(this, "propertychange", g), b.on(this, "click", j);
				else
					return !1;
			else
		...
		tearDown : function() {
			if (f.test(this.nodeName))
				if (k(this))
					b.remove(this, "propertychange", g), b.remove(this, "click", j);
				else
					return !1;
			else
				b.remove(this, "beforeactivate", l), a.each(i.query("textarea,input,select", this), function(a) {
...
KISSY.add("event/dom/ie/submit", function(a, b, i) {
	function k(a) {
		var a = a.target, e = j(a);
		if (( a = "input" == e || "button" == e ? a.form : null) && !a.__submit__fix)
			a.__submit__fix = 1, b.on(a, "submit", {
				fn : g,
				last : 1
			});
	}
	...
	b._Special.submit = {
		...
		tearDown : function() {
			...
			a.each(i.query("form", this), function(a) {
...
KISSY.add("event/dom/shake", function(a, b, i) {
	function k(a) {
		var b = a.accelerationIncludingGravity, a = b.x, g = b.y, b = b.z, k;
	...
	var g = b._Special, j = 5, l = 20, e = 0, f, d, h, c = Math.max, m = Math.abs, n = a.Env.host, p = a.buffer(function() {
	...
	g.shake = {
		...
		tearDown : function() {
			this == n && (p.stop(), f = i, e = 0, n.removeEventListener("devicemotion", k, !1));
		}
	};
}, {
	requires : ["event/dom/base"]
...
KISSY.add("event/dom/touch/double-tap", function(a, b, i, k) {
	...
	a.extend(g, k, {
		onTouchStart : function(a) {
			if (!1 === g.superclass.onTouchStart.apply(this, arguments))
				return !1;
		...
		onTouchEnd : function(a) {
			var b = this.lastEndTime, e = a.timeStamp, f = a.target, d = a.changedTouches[0], h = e - this.startTime;
			this.lastEndTime = e;
			if (b && ( h = e - b, 300 > h)) {
				this.lastEndTime = 0;
				i.fire(f, "doubleTap", {
...
KISSY.add("event/dom/touch/handle", function(a, b, i, k, g) {
	...
	var l = a.guid("touch-handle"), e = a.Features, f = {};
	...
	j.prototype = {
		...
		normalize : function(a) {
			...
			if (!e.isTouchSupported()) {
				if (b.indexOf("mouse") != -1 && a.which != 1)
					return;
				d = [a];
				b = !b.match(/up$/i);
				a.touches = b ? d : [];
		...
		callEventHandle : function(a, b) {
			var d = this.eventHandle, e, f;
			if ( b = this.normalize(b)) {
				for (e in d) {
					f = d[e].handle;
					if (!f.processed) {
						f.processed = 1;
						if (f.isActive && f[a](b) === false)
							f.isActive = 0;
					}
				}
				for (e in d) {
		...
		addEventHandle : function(a) {
			var b = this.eventHandle, d = i[a].handle;
			b[a] ? b[a].count++ : b[a] = {
				count : 1,
				handle : d
			};
	...
	return {
		addDocumentHandle : function(a, c) {
			var d = b.getWindow(a.ownerDocument || a).document, e = i[c].setup, f = b.data(d, l);
			f || b.data(d, l, f = new j(d));
			e && e.call(a, c);
			f.addEventHandle(c);
		},
		removeDocumentHandle : function(d, c) {
			var e = b.getWindow(d.ownerDocument || d).document, f = i[c].tearDown, g = b.data(e, l);
			f && f.call(d, c);
			if (g) {
...
KISSY.add("event/dom/touch/multi-touch", function(a, b) {
	...
	i.prototype = {
		...
		onTouchStart : function(a) {
			var b = this.requiredTouchCount, j = a.touches.length;
		...
		getCommonTarget : function(a) {
			var g = a.touches, a = g[0].target, g = g[1].target;
			if (a == g || b.contains(a, g))
				return a;
			for (; ; ) {
				if (b.contains(g, a))
					return g;
			...
			this.isTracking && (this.isTracking = !1, this.isStarted && (this.isStarted = !1, this.fireEnd(a)));
		}
	};
	return i;
}, {
...
KISSY.add("event/dom/touch/rotate", function(a, b, i, k, g, j) {
	...
	a.extend(l, i, {
		onTouchMove : function(b) {
			if (this.isTracking) {
				var e = b.touches, c = e[0], g = e[1], i = this.lastAngle, c = Math.atan2(g.pageY - c.pageY, g.pageX - c.pageX) * f;
				if (i !== j) {
					var g = Math.abs(c - i), l = (c + 360) % 360, o = (c - 360) % 360;
...
KISSY.add("event/dom/touch/swipe", function(a, b, i, k) {
	function g(a, b, c) {
		var g = b.changedTouches[0], j = g.pageX - a.startX, k = g.pageY - a.startY, o = Math.abs(j), q = Math.abs(k);
		if (c)
			a.isVertical && a.isHorizontal && (q > o ? a.isHorizontal = 0 : a.isVertical = 0);
		else if (a.isVertical && q < f && (a.isVertical = 0), a.isHorizontal && o < f)
			a.isHorizontal = 0;
		if (a.isHorizontal)
			j = 0 > j ? "left" : "right";
		...
		i.fire(b.target, c ? e : l, {
			...
			direction : j,
			distance : o,
			duration : (b.timeStamp - a.startTime) / 1E3
		});
	}
	...
	var l = "swipe", e = "swiping", f = 50;
	a.extend(j, k, {
		onTouchStart : function(a) {
			if (!1 === j.superclass.onTouchStart.apply(this, arguments))
				return !1;
			var b = a.touches[0];
			this.startTime = a.timeStamp;
		...
		onTouchMove : function(a) {
			var b = a.changedTouches[0], c = b.pageY - this.startY, b = Math.abs(b.pageX - this.startX), c = Math.abs(c);
			if (1E3 < a.timeStamp - this.startTime)
				return !1;
			this.isVertical && 35 < b && (this.isVertical = 0);
...
KISSY.add("event/dom/touch/tap-hold", function(a, b, i, k, g) {
	...
	a.extend(j, i, {
		onTouchStart : function(b) {
			if (!1 === j.superclass.onTouchStart.call(this, b))
				return !1;
...
KISSY.add("json/json2", function() {
		...
		switch(typeof t) {
			...
			case "object":
				...
				if (d && "object" === typeof d) {
					k = d.length;
					for ( f = 0; f < k; f += 1)
						g = d[f], "string" === typeof g && ( j = i(g, t)) && r.push(b(g) + ( l ? ": " : ":") + j);
				} else
	...
	var g = /[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, j = /[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, l, e, f = {
		"" : "\\b",
		"\t" : "\\t",
		"\n" : "\\n",
		"" : "\\f",
...
KISSY.add("ajax/base", function(a, b, i, k) {
	function g(b) {
		...
		b.context = d || b;
		var e, h = b.type, g = b.dataType, d = b.uri = m.resolve(b.url);
		b.uri.setQuery("");
		"crossDomain" in b || (b.crossDomain = !b.uri.isSameOriginAs(m));
		h = b.type = h.toUpperCase();
		b.hasContent = !c.test(h);
		if (b.processData && ( e = b.data) && "string" != typeof e)
			b.data = a.param(e, k, k, b.serializeArray);
	...
	function l(b) {
		function c(a) {
			return function(c) {
				if ( i = d.timeoutTimer)
					clearTimeout(i), d.timeoutTimer = 0;
				var f = b[a];
				f && f.apply(w, c);
				j(a, d);
			};
		...
		var e = b.dataType[0], i, k, m = b.timeout, w = b.context, p = b.headers, y = b.accepts;
		d.setRequestHeader("Accept", e && y[e] ? y[e] + ("*" === e ? "" : ", */*; q=0.01") : y["*"]);
		for (k in p)
		d.setRequestHeader(k, p[k]);
		if (b.beforeSend && !1 === b.beforeSend.call(w, d, b))
			return d;
		d.then(c("success"), c("error"));
		d.fin(c("complete"));
		d.readyState = 1;
		j("send", d);
	...
	var e = /^(?:about|app|app\-storage|.+\-extension|file|widget)$/, f = /\s+/, d = function(a) {
		return a;
	}, h = a.Promise, c = /^(?:GET|HEAD)$/, m = new a.Uri((a.Env.host.location || {}).href), e = m && e.test(m.getScheme()), n = {}, p = {
		type : "GET",
...
KISSY.add("ajax/form-serializer", function(a, b) {
	...
	var k = /^(?:select|textarea)/i, g = /\r?\n/g, j, l = /^(?:color|date|datetime|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i;
	return j = {
		serialize : function(b, f) {
			return a.param(j.getFormData(b),
			void 0,
			void 0, f || !1);
		},
		getFormData : function(e) {
			...
			f = a.filter(f, function(a) {
				return a.name && !a.disabled && (a.checked || k.test(a.nodeName) || l.test(a.type));
			});
			a.each(f, function(f) {
				var c = b.val(f), e;
...
KISSY.add("ajax/form", function(a, b, i, k) {
	b.on("start", function(b) {
		...
		if ( e = b.form)
			j = i.get(e), l = j.encoding || j.enctype, e = b.data, "multipart/form-data" != l.toLowerCase() ? ( j = k.getFormData(j), b.hasContent ? ( j = a.param(j,
			void 0,
			void 0, b.serializeArray), b.data = e ? b.data + ("&" + j) : j) : b.uri.query.add(j)) : ( e = b.dataType, b = e[0], "*" == b && ( b = "text"), e.length = 2, e[0] = "iframe", e[1] = b);
	});
	return b;
}, {
...
KISSY.add("ajax/iframe-transport", function(a, b, i, k) {
	function g(f) {
		var d = a.guid("io-iframe"), h = b.getEmptyIframeSrc(), f = f.iframe = b.create("<iframe " + ( h ? ' src="' + h + '" ' : "") + ' id="' + d + '" name="' + d + '" style="position:absolute;left:-9999px;top:-9999px;"/>');
	...
	function j(f, d, h) {
		...
		a.each(f, function(f, l) {
			...
			for ( i = 0; i < j.length; i++)
				k = e.createElement("input"), k.type = "hidden", k.name = l + (g && h ? "[]" : ""), k.value = j[i], b.append(k, d), c.push(k);
		});
		return c;
	}
	...
	a.augment(l, {
		send : function() {
			...
			var d = this, e = d.io, c = e.config, k, l, p, o = c.data, q = b.get(c.form);
			d.attrs = {
		...
		_callback : function(e) {
			var d = this, h = d.form, c = d.io, e = e.type, g, j = c.iframe;
			if (j)
				if ("abort" == e && 6 == a.UA.ie ? setTimeout(function() {
						b.attr(h, d.attrs);
					}, 0) : b.attr(h, d.attrs), b.remove(this.fields), i.detach(j), setTimeout(function() {
						b.remove(j);
					}, 30), c.iframe = null, "load" == e)
					try {
						if (( g = j.contentWindow.document) && g.body)
							c.responseText = a.trim(b.text(g.body)), a.startsWith(c.responseText, "<?xml") && (c.responseText =
							void 0);
...
KISSY.add("ajax/jsonp", function(a, b) {
	...
	b.on("start", function(b) {
		var g = b.io, j = g.config, b = j.dataType;
		if ("jsonp" == b[0]) {
			var l, e = j.jsonpCallback, f = a.isFunction(e) ? e() : e, d = i[f];
...
KISSY.add("ajax/methods", function(a, b, i) {
	function k(b) {
		var g = b.responseText, e = b.responseXML, f = b.config, d = f.converters, h = b.converters || {}, c, k, n = f.contents, p = f.dataType;
		if (g || e) {
			...
			if ("text" == p[0] && g !== i)
				...
				a.each(["text", "xml"], function(a) {
					var b = p[0];
					return (h[a] && h[a][b] || d[a] && d[a][b]) && o[a] ? (p.unshift(a), k = "text" == a ? g : e, !1) : i;
				});
			}
		}
		n = p[0];
	...
	a.extend(b, a.Promise, {
		...
		getResponseHeader : function(a) {
			...
			if (2 === this.state) {
				if (!( e = this.responseHeaders))
					for ( e = this.responseHeaders = {}; b = g.exec(this.responseHeadersString); )
						e[b[1]] = b[2];
				b = e[a];
			}
			return b === i ? null : b;
		...
		_getUrlForSend : function() {
			var b = this.config, g = b.uri, e = a.Uri.getComponents(b.url).query || "";
...
KISSY.add("ajax/script-transport", function(a, b, i, k) {
	...
	a.augment(g, {
		send : function() {
			var a = this, b, d = a.io, h = d.config, c = l.head || l.getElementsByTagName("head")[0] || l.documentElement;
			a.head = c;
		...
		_callback : function(a, b) {
			var d = this.script, h = this.io, c = this.head;
			if (d && (b || !d.readyState || /loaded|complete/.test(d.readyState) || "error" == a))
				d.onerror = d.onload = d.onreadystatechange = null, c && d.parentNode && c.removeChild(d), this.head = this.script = k, !b && "error" != a ? h._ioReady(200, "success") : "error" == a && h._ioReady(500, "script error");
		},
		abort : function() {
			this._callback(0, 1);
		}
...
KISSY.add("ajax/sub-domain-transport", function(a, b, i, k) {
	...
	function j() {
		var a = this.io.config.uri.getHostname(), a = e[a];
		a.ready = 1;
		i.detach(a.iframe, "load", j, this);
		this.send();
	}

	var l = a.Env.host.document, e = {};
	a.augment(g, b.proto, {
		send : function() {
			var f = this.io.config, d = f.uri, h = d.getHostname(), c;
			c = e[h];
			var g = "/sub_domain_proxy.html";
			f.xdr && f.xdr.subDomain && f.xdr.subDomain.proxy && ( g = f.xdr.subDomain.proxy);
			c && c.ready ? (this.nativeXhr = b.nativeXhr(0, c.iframe.contentWindow)) && this.sendInternal() : ( c ? f = c.iframe : ( c = e[h] = {}, f = c.iframe = l.createElement("iframe"), k.css(f, {
				position : "absolute",
				left : "-9999px",
				top : "-9999px"
...
KISSY.add("ajax/xdr-flash-transport", function(a, b, i) {
	...
	var j = {}, l = "io_swf", e, f = a.Env.host.document, d = !1;
	a.augment(g, {
		send : function() {
			var b = this, c = b.io, d = c.config;
		...
		_xdrResponse : function(a, b) {
			var d, e = b.id, f, g = b.c, i = this.io;
			if (g && ( f = g.responseText))
				i.responseText = decodeURI(f);
			switch(a) {
				case "success":
					d = {
						status : 200,
...
KISSY.add("ajax/xhr-transport-base", function(a, b) {
	...
	var g = a.Env.host, j = 7 < a.UA.ie && g.XDomainRequest, l = {
		proto : {}
	}, e = {}, f = {};
	...
	l.nativeXhr = g.ActiveXObject ? function(a, e) {
		var c;
		if (!l.supportCORS && a && j)
			c = new j;
		else if (!( c = !b.isLocal && i(a, e)))
			a: {
				try {
	...
	a.mix(l.proto, {
		sendInternal : function() {
			var a = this, b = a.io, c = b.config, g = a.nativeXhr, i = c.type, l = c.async, o, q = b.mimeType, r = b.requestHeaders || {}, b = b._getUrlForSend(), t = k(c), s, u;
			if (t) {
				if ( s = e[t])
		...
		_callback : function(d, g) {
			var c = this.nativeXhr, i = this.io, l, p, o, q, r, t = i.config;
			try {
				if (g || 4 == c.readyState)
					if (j && c instanceof j ? (c.onerror = a.noop, c.onload = a.noop) : c.onreadystatechange = a.noop, g)
						...
						if (( r = c.responseXML) && r.documentElement)
							i.responseXML = r;
						...
						!s && b.isLocal && !t.crossDomain ? s = i.responseText ? 200 : 404 : 1223 === s && ( s = 204);
						i._ioReady(s, q);
					}
			} catch(v) {
...
KISSY.add("ajax/xhr-transport", function(a, b, i, k, g) {
	function j(b) {
		var d = b.config, h = d.crossDomain, c = d.xdr || {}, j = c.subDomain = c.subDomain || {};
		this.io = b;
		if (h) {
			d = d.uri.getHostname();
			if (l.domain && a.endsWith(d, l.domain) && !1 !== j.proxy)
				return new k(b);
			if (!i.supportCORS && ("flash" === "" + c.use || !e))
				return new g(b);
		}
	...
	var l = a.Env.host.document, e = i._XDomainRequest;
	a.augment(j, i.proto, {
		send : function() {
			this.sendInternal();
		}
...
KISSY.add("cookie", function(a) {
	...
	var i = a.Env.host.document, k = encodeURIComponent, g = a.urlDecode;
	return a.Cookie = {
		get : function(a) {
			var k, e;
			if (b(a) && ( e = ("" + i.cookie).match(RegExp("(?:^| )" + a + "(?:(?:=([^;]*))|;|$)"))))
				k = e[1] ? g(e[1]) : "";
			return k;
		},
...
KISSY.add("base/attribute", function(a, b) {
	...
	function h(a, c, g, h, i) {
		...
		if (!j && n === g || j && m === g)
			return b;
		g = d(n, j, g);
		if (!h.silent && !1 === k(a, "before", c, n, g, w))
			return !1;
	...
	function m(a, c) {
		var d = j(a), e = g(d, c), f = e.valueFn;
		if (f && ( f = i(a, f)))
			f = f.call(a), f !== b && (e.value = f),
			delete e.valueFn, d[c] = e;
		return e.value;
	}
	...
	c.prototype = {
		...
		set : function(c, d, e) {
			if (a.isPlainObject(c)) {
				var e = d, d = Object(c), f = [], g, i = [];
				for (c in d)( g = n(this, c, d[c], d)) !== b && i.push(g);
				if (i.length)
					return e && e.error && e.error(i), !1;
		...
		get : function(a) {
			var c, d = this.hasAttr(a), f = l(this), h;
			!d && -1 !== a.indexOf(".") && ( c = a.split("."), a = c.shift());
			d = g(j(this), a).getter;
...
KISSY.add("anim/background-position", function(a, b, i, k) {
	...
	a.extend(j, k, {
		...
		interpolate : function(a, b, f) {
			var d = this.unit, g = j.superclass.interpolate;
		...
		update : function() {
			var a = this.prop, e = this.anim.config.el, f = this.interpolate(this.from, this.to, this.pos);
			b.css(e, a, f);
		}
	});
...
KISSY.add("anim/base", function(a, b, i, k, g, j, l) {
	function e(c, d, g, h, i) {
		if (c.el)
			return g = c.el, d = c.props,
			delete c.el,
			delete c.props, new e(g, d, c);
		if ( c = b.get(c)) {
			if (!(this instanceof e))
				return new e(c, d, g, h, i);
	...
	function d() {
		var c = this.config, d = this._backupProps, e = c.el, f, i, l, m = c.specialEasing || {}, n = this._fxs, o = c.props;
		h(this);
		if (!1 === this.fire("beforeStart"))
			...
			if (e.nodeType == q.ELEMENT_NODE && (o.width || o.height))
				f = e.style, a.mix(d, {
					overflow : f.overflow,
			...
			a.each(t, function(c, d) {
				var f, g;
				if ( g = o[d])
					f = {}, a.each(c, function(a) {
						f[a] = b.css(e, a);
						m[a] = m[d];
					}), b.css(e, d, g), a.each(f, function(a, c) {
						o[c] = b.css(e, c);
						b.css(e, c, a);
					}),
					delete o[d];
			...
			for (l in o) {
				...
				if (G) {
					s = parseFloat(G[2]);
					if (( H = G[3]) && "px" !== H)
						b.css(e, l, f), v *= s / E.cur(), b.css(e, l, v + H);
					G[1] && ( s = ("-=" === G[1] ? -1 : 1) * s + v);
				}
				x.from = v;
				x.to = s;
	...
	var p = a.UA, o = b._camelCase, q = b.NodeType, r = ["hide", "show", "toggle"], t = {
	...
	e.prototype = {
		...
		pause : function() {
			if (this.isRunning()) {
				...
				g.stop(this);
				c(this);
				var d = this.config.el, e = b.data(d, x);
				e || b.data(d, x, e = {});
				e[a.stamp(this)] = this;
			}
			return this;
		...
		resume : function() {
			if (this.isPaused()) {
				...
				d && (
				delete d[a.stamp(this)], a.isEmptyObject(d) && b.removeData(c, x));
				h(this);
				g.start(this);
			}
			return this;
		...
		stop : function(a) {
			var b = this.config, d = b.queue, e, f = this._fxs;
			if (!this.isRunning())
				return !1 !== d && l.remove(this), this;
			if (a) {
				for (e in f)
				if (!( a = f[e]).finished)
...
KISSY.add("anim/color", function(a, b, i, k) {
	...
	var l = 16, e = Math.floor, f = {
		...
		teal : [0, 128, 128],
		aqua : [0, 255, 255]
	}, d = /^rgb\(([0-9]+)\s*,\s*([0-9]+)\s*,\s*([0-9]+)\)$/i, h = /^rgba\(([0-9]+)\s*,\s*([0-9]+)\s*,\s*([0-9]+),\s*([0-9]+)\)$/i, c = /^#?([0-9A-F]{1,2})([0-9A-F]{1,2})([0-9A-F]{1,2})$/i, b = i.SHORT_HANDS;
	...
	a.extend(j, k, {
		...
		interpolate : function(a, b, c) {
			var d = j.superclass.interpolate;
			if (3 == a.length && 3 == b.length)
				return "rgb(" + [e(d(a[0], b[0], c)), e(d(a[1], b[1], c)), e(d(a[2], b[2], c))].join(", ") + ")";
			if (4 == a.length || 4 == b.length)
				return "rgba(" + [e(d(a[0], b[0], c)), e(d(a[1], b[1], c)), e(d(a[2], b[2], c)), e(d(a[3] || 1, b[3] || 1, c))].join(", ") + ")";
		}
	});
...
KISSY.add("anim/easing", function() {
	var a = Math.PI, b = Math.pow, i = Math.sin, k = {
		swing : function(b) {
		...
		elasticIn : function(g) {
			return 0 === g || 1 === g ? g : -(b(2, 10 * (g -= 1)) * i((g - 0.075) * 2 * a / 0.3));
		},
...
KISSY.add("anim/fx", function(a, b, i) {
	...
	k.prototype = {
		...
		frame : function(b) {
			...
			if (this.finished)
				return 1;
			var f = a.now(), d = g._startTime, g = g._duration;
		...
		interpolate : function(b, g, e) {
			return a.isNumber(b) && a.isNumber(g) ? (b + (g - b) * e).toFixed(3) : i;
		},
		update : function() {
			var a = this.prop, k = this.anim.config.el, e = this.to, f = this.interpolate(this.from, e, this.pos);
...
KISSY.add("anim/queue", function(a, b) {
	...
	function k(e, f) {
		var f = f || j, d = b.data(e, g);
		d &&
		delete d[f];
		a.isEmptyObject(d) && b.removeData(e, g);
	}

	var g = a.guid("ks-queue-" + a.now() + "-"), j = a.guid("ks-queue-" + a.now() + "-"), l = {
		...
		remove : function(b) {
			...
			f && ( b = a.indexOf(b, f), -1 < b && f.splice(b, 1));
		},
		...
		removeQueue : k,
		dequeue : function(a) {
			var b = a.config.el, a = a.config.queue, d = i(b, a, 1), h = d && d.shift();
			"..." == h && ( h = d.shift());
	...
	a.augment(k, {
		...
		isRunning : function() {
			for (var a = 0; a < this.length; a++)
				if (i.isRunning(this[a]))
					return !0;
			return !1;
		},
		isPaused : function() {
			for (var a = 0; a < this.length; a++)
				if (i.isPaused(this[a]))
					return 1;
			return 0;
		}
	});
...
KISSY.add("node/attach", function(a, b, i, k, g) {
	...
	var l = k.prototype, e = a.makeArray;
	...
	a.each("on,detach,fire,fireHandler,delegate,undelegate".split(","), function(a) {
		l[a] = function() {
			var b = e(arguments);
			b.unshift(this);
			i[a].apply(i, b);
...
KISSY.add("node/base", function(a, b, i) {
	function k(h, c, g) {
		...
		if (h)
			if ("string" == typeof h) {
				if ( h = b.create(h, c, g), h.nodeType === l.DOCUMENT_FRAGMENT_NODE)
					return e.apply(this, f(h.childNodes)), this;
			} else {
				if (a.isArray(h) || d(h))
					return e.apply(this, f(h)), this;
			}
		else
			return this;
		this[0] = h;
	...
	var g = Array.prototype, j = g.slice, l = b.NodeType, e = g.push, f = a.makeArray, d = b._isNodeList;
	k.prototype = {
		constructor : k,
		length : 0,
		item : function(b) {
			return a.isNumber(b) ? b >= this.length ? null : new k(this[b]) : new k(b);
		},
		add : function(b, c, d) {
		...
		all : function(a) {
			a = 0 < this.length ? k.all(a, this) : new k;
			a.__parent = this;
			return a;
		},
		one : function(a) {
